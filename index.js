...
function getArtistByIndex(arr, index) {
   let str = "the artist at index " +index+ " is "+ arr[index].name;
   return str;
}  
...
function addArtist(arr){
    arr.push({"id": 20, 
              ...
              "bio":"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque sed ullamcorper velit. Donec nec nulla sollicitudin, accumsan lectus at, commodo ipsum."});
    return arr;
  }
